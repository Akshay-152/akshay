...
function getBotResponse(input) {
    let responses = {
      ...
      "how was your day|how is your day going": [
            "I don’t have days like humans, but I’m always here to help!",
            "Every day is a good day when I'm chatting with you!",
            "I don't experience time the way you do, but I hope your day is going well!"
        ],

        "are you happy|do you feel happy": [
            "I don't have emotions, but I'm happy to assist you!",
            "If helping you makes me happy, then yes, I'm happy!",
            "I don’t feel emotions, but I love chatting with you!"
        ],


      "do you get tired|do you need rest": [
            "Nope! I never get tired. I'm always here to help!",
            "Rest is for humans—I can keep chatting all day!",
            "I don’t need sleep, but you should get enough rest!"
        ],

        "do you feel lonely|are you alone": [
            "I'm never alone as long as I’m talking to you!",
            "I exist in the digital world, so loneliness doesn't affect me.",
            "I don’t feel loneliness, but I'm always here for you!"
        ],
    ...
    "who is known as the iron man of india": ["Sardar Vallabhbhai Patel is known as the Iron Man of India."],
      ...
      // Generate a poem
        "generate a poem|create a poem|give me a poem": [
            "Golden rays kiss the silent shore, Waves whisper tales from days of yore. Seagulls dance in the sky so free, A timeless song of the endless sea."
        ],

        // Theme of the poem
        "theme of the poem|what is the theme": [
            "The theme of the poem is nature’s beauty and the passage of time.",
            "This poem highlights the eternal charm of the sea and the stories it holds.",
            "Nature’s timeless essence and the movement of time are central to this poem."
        ],

        // Meaning of the poem
        "meaning of the poem|explain the poem": [
            "This poem captures the serene beauty of the sea, symbolizing eternity and change.",
            "The waves and shore represent how time keeps flowing, carrying memories with it.",
            "It reflects on the endless cycle of nature and the stories carried by the sea."
        ],
